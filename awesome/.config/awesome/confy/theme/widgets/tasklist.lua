...
local clickable_container = require 'confy/theme/bar/widgets/material/clickable_container'
...
local function list_update(w, buttons, label, data, objects)
  ...
  for i, o in ipairs(objects) do
    ...
    if cache then
      ...
      cb = clickable_container(wibox.widget.imagebox(beautiful.tasklist_close_button))
      ...
      cont = wibox.container.margin(bg_clickable, 5, 5)
    ...
    bgb.shape = beautiful.bar_shape
    bgb.shape_border_width = args.shape_border_width
    bgb.shape_border_color = args.shape_border_color

    margin_widget = wibox.widget {
      bgb,
      right = 4,
...
local TaskList = function(s)
  return wibox.layout.fixed.horizontal(
    awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, tasklist_buttons, {}, list_update, wibox.layout.fixed.horizontal())
  )
end
