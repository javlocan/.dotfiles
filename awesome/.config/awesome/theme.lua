...
--         wibox.container.margin(wibox.widget { mailicon, theme.mail and theme.mail.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(7)),
--         '#343434'
--       ),
--       arrow('#343434', theme.bg_normal),
--       wibox.container.background(
--         wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(6)),
--         theme.bg_focus
--       ),
--       arrow(theme.bg_normal, '#343434'),
...
--       arrow('#4B696D', '#4B3B51'),
--       wibox.container.background(
--         wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(4)),
--         '#4B3B51'
--       ),
--       arrow('#4B3B51', '#CB755B'),
--       wibox.container.background(
--         wibox.container.margin(wibox.widget { fsicon, theme.fs and theme.fs.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)),
--         '#CB755B'
--       ),
--       arrow('#CB755B', '#8DAA9A'),
--       wibox.container.background(
--         wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)),
--         '#8DAA9A'
--       ),
--       arrow('#8DAA9A', '#C0C0A2'),
--       wibox.container.background(
--         wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)),
--         '#C0C0A2'
--       ),
--       arrow('#C0C0A2', 'alpha'),
--       --]]
